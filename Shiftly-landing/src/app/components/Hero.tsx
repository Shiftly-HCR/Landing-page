        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button className="group px-8 py-4 bg-[#782478] text-[#fcfaf7] rounded-lg hover:bg-[#cc9933] transition-all transform hover:scale-105 flex items-center justify-center gap-2 font-semibold text-lg">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <button className="px-8 py-4 bg-[#fcfaf7] border-2 border-[#782478] text-[#782478] rounded-lg hover:bg-[#782478] hover:text-[#fcfaf7] transition-all transform hover:scale-105 flex items-center justify-center gap-2 font-semibold">
                <Users className="w-5 h-5" />
                Je suis freelance
              </button>
              <button className="px-8 py-4 bg-[#fcfaf7] border-2 border-[#cc9933] text-[#cc9933] rounded-lg hover:bg-[#cc9933] hover:text-[#fcfaf7] transition-all transform hover:scale-105 flex items-center justify-center gap-2 font-semibold">
