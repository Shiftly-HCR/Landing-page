    ...
    <section className="py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-[#782478] via-[#782478] to-[#cc9933] relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center relative">
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center">
          <button className="group px-10 py-5 bg-[#fcfaf7] text-[#782478] rounded-lg hover:bg-[#fcfaf7]/90 transition-all transform hover:scale-105 flex items-center justify-center gap-3 font-bold text-lg shadow-2xl">
            <Users className="w-6 h-6" />
            Je suis freelance
          </button>

          <button className="group px-10 py-5 bg-[#cc9933] text-[#fcfaf7] rounded-lg hover:bg-[#cc9933]/90 transition-all transform hover:scale-105 flex items-center justify-center gap-3 font-bold text-lg shadow-2xl border-2 border-[#fcfaf7]/20">
